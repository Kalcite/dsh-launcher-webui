import { Github, LayoutDashboard, Rocket, RefreshCw, Puzzle, Command, Zap, ListTodo, Settings, BarChart3 } from "lucide-react";
import type { EnvInfo } from "../api";

export type Page = "overview" | "deploy" | "update" | "plugins" | "events" | "settings" | "usage";
...
const NAV: NavItem[] = [
  ...
  { icon: BarChart3, label: "用量分析", page: "usage" },
